...
const ConsultationHero = () => {
  ...
  return (
    <section className="mb-20 animate-fade-in px-4 sm:px-0">
      <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
        <div className="text-center lg:text-left">
          <h1 className="mb-6 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-[hsl(var(--hero-gradient-start))] to-[hsl(var(--hero-gradient-end))] bg-clip-text text-transparent leading-tight">
            AI Strategy & Implementation Sprint
          </h1>
          <h2 className="mb-6 text-xl sm:text-2xl md:text-3xl font-semibold text-foreground leading-snug">
          ...
          <Button 
            ...
            size="lg"
            className="bg-[hsl(var(--hero-button))] hover:bg-[hsl(var(--hero-button-hover))] text-white font-semibold text-sm sm:text-base md:text-lg px-4 sm:px-6 md:px-8 py-4 sm:py-5 md:py-6 h-auto w-full sm:w-auto"
          >
            <span className="block sm:hidden">Book Session ($299 Credit)</span>
            <span className="hidden sm:block">Book Your Session ($299 Credit Applied)</span>
          </Button>
        </div>
